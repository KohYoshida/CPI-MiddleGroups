document.addEventListener("DOMContentLoaded", function() {
    let currentHitWidth = 200;  // hitWidthの初期値

    d3.csv("indicesMiddleGroups.csv", function(d) {
        return {
        ...
        let tickValues = d3.range(startYear, endYear, 1);  // 1年ごとに値を生成
        ...
        */
        ...
        function toggleHitWidth() {
            ...
            currentHitWidth = currentHitWidth === 200 ? 0 : 200;
            const button = document.getElementById("toggleButton");
            button.textContent = currentHitWidth === 150 ? "推移を調べる" : "品目を調べる→プルダウンで選択";
